defmodule ApmWeb.V2.ProvenanceW4ControllerTest do
  @moduledoc """
  ...
  Run with: mix test test/apm_web/controllers/v2/provenance_w4_controller_test.exs
  """
  ...
  alias Apm.Provenance.{ArtifactAttestation, ArtifactAttestation.Signer}

  # ── Setup ─────────────────────────────────────────────────────────────────

  setup do
    # PubSub is started as part of the test application (ApmWeb.Endpoint supervisor).
