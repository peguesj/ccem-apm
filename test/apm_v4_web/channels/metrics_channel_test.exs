defmodule ApmV4Web.MetricsChannelTest do
  use ApmV4Web.ChannelCase

  setup do
    if Process.whereis(ApmV4.MetricsCollector), do: ApmV4.MetricsCollector.clear_all()

    {:ok, _, socket} =
      ApmV4Web.UserSocket
      |> socket(%{})
      |> subscribe_and_join(ApmV4Web.MetricsChannel, "metrics:live")
