defmodule ApmV5.A2A.FileLockRegistryTest do
  @moduledoc """
  Tests for ApmV5.A2A.FileLockRegistry — pessimistic file lock with TTL.
  ...
  setup do
    ...
    Phoenix.PubSub.subscribe(ApmV5.PubSub, "a2a:locks")
