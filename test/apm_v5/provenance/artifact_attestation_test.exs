defmodule ApmV5.Provenance.ArtifactAttestationTest do
  @moduledoc """
  TDD suite for ApmV5.Provenance.ArtifactAttestation (prov-w1-s3 / CP-277).
  ...
  alias ApmV5.Provenance.ArtifactAttestation.Signer
  ...
  describe "Signer.sign_artifact/4" do
    ...
    test "subject list contains the file path and sha256 hash" do
      path = "lib/apm_v5/identity/key_store.ex"
    ...
    test "signature verifies with KeyStore public key (roundtrip)" do
      attest = Signer.sign_artifact("Write", "lib/apm_v5/identity/key_store.ex", "agent-1", %{})
      ...
      assert KeyStore.verify(ApmV5.Identity.KeyStore, payload, attest.signature, pub) == true,
    ...
    test "signature fails verification with tampered subject" do
      ...
      assert KeyStore.verify(ApmV5.Identity.KeyStore, payload, attest.signature, pub) == false
    end
  end
