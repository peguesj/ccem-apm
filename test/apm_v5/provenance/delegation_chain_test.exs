defmodule ApmV5.Provenance.DelegationChainTest do
  @moduledoc """
  TDD suite for ApmV5.Provenance.DelegationChain (prov-w3-s7 / CP-281).
  ...
  alias ApmV5.Provenance.DelegationChain
  ...
  describe "AgentRegistry.register_agent/3 with parent_agent_id" do
    ...
    test "stores delegation_chain when parent_agent_id is present" do
      ...
      :ok = ApmV5.AgentRegistry.register_agent("parent-orchestrator", %{}, nil)
      ...
      agent = ApmV5.AgentRegistry.get_agent("child-swarm-agent")
      assert agent != nil
    ...
    test "does not set delegation_chain when parent_agent_id is absent" do
      ...
      agent = ApmV5.AgentRegistry.get_agent("standalone-agent")
      assert agent != nil
