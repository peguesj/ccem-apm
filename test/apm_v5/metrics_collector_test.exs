defmodule ApmV5.MetricsCollectorTest do
  ...
  describe "compute_health_score/1" do
    ...
    test "agent with zero errors scores higher than agent with many errors" do
      ApmV5.AgentRegistry.register_agent("good-agent", %{status: "running"})
      ApmV5.AgentRegistry.register_agent("bad-agent", %{status: "running"})
