defmodule ApmV5Web.ApprovalControllerWebAuthnTest do
  @moduledoc """
  ...
  setup do
    ...
    Application.put_env(:apm_v5, :require_webauthn_for_approval, false)
    on_exit(fn -> Application.put_env(:apm_v5, :require_webauthn_for_approval, false) end)
    :ok
  end
  ...
  describe "POST /api/v2/approvals/:id/approve (webauthn required)" do
    setup do
      Application.put_env(:apm_v5, :require_webauthn_for_approval, true)
      :ok
    end
