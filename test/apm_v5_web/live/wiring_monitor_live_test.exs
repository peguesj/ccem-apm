defmodule ApmV5Web.WiringMonitorLiveTest do
  @moduledoc """
  TDD suite for Phase 0.4 — WiringMonitorLive and ApmV5.WiringMonitor.
  ...
  Run with: mix test test/apm_v5_web/live/wiring_monitor_live_test.exs
  """
  ...
  describe "ApmV5Web.WiringMonitorLive module" do
    test "module is defined and loaded" do
      assert Code.ensure_loaded?(ApmV5Web.WiringMonitorLive)
    end

    test "implements LiveView mount/3" do
      assert function_exported?(ApmV5Web.WiringMonitorLive, :mount, 3)
    end

    test "implements LiveView render/1" do
      assert function_exported?(ApmV5Web.WiringMonitorLive, :render, 1)
    end
    ...
    test "route /health/wiring is registered in the router" do
      ...
      wiring_routes =
        ApmV5.WiringMonitor.routes()
        |> Enum.filter(fn r ->
          r.path == "/health/wiring" and r.plug == ApmV5Web.WiringMonitorLive
        end)
  ...
  describe "W1 check_route_resolution/0 — fixture scenarios" do
    ...
    test "accepts a real LiveView module as success" do
      mod = ApmV5Web.WiringMonitorLive
  ...
  describe "ApmV5.WiringMonitor.Finding" do
