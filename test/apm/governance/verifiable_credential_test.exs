defmodule Apm.Governance.VerifiableCredentialTest do
  @moduledoc """
  TDD suite for Apm.Governance.VerifiableCredential (CP-300 / comp-v10.3-s2).
  ...
  describe "ControlRegistry :verifiable_credentials control" do
    test "control exists and is satisfied" do
      ctrl = Apm.Governance.ControlRegistry.get_control(:verifiable_credentials)
      assert ctrl != nil
    ...
    test "controls_by_framework returns :verifiable_credentials for EU AI Act Article 13" do
      ctrl_ids = Apm.Governance.ControlRegistry.controls_by_framework(:eu_ai_act, "Article 13")
