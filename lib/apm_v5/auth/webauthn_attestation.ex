defmodule ApmV5.Auth.WebAuthnAttestation do
  @moduledoc """
  ...
  @doc """
  Initialise the credentials ETS table. Called from `ApmV5.Application` at
  boot. Idempotent.
  """
  @spec init_table() :: :ok
  def init_table do
  ...
  def require_webauthn? do
    Application.get_env(:apm_v5, :require_webauthn_for_approval, false) == true
  end
