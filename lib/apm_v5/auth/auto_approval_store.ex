defmodule ApmV5.Auth.AutoApprovalStore do
  @moduledoc """
  ...
  ## Example Usage
      ...
      case ApmV5.Auth.AutoApprovalStore.find_matching(agent_id, formation_id, session_id, project, tool_name, risk_level) do
