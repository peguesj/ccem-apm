defmodule ApmV5.LayoutStore do
  @moduledoc """
  ...
  ## Usage
      ...
      ApmV5.LayoutStore.list_presets()
      ApmV5.LayoutStore.get_preset("default")
      ApmV5.LayoutStore.save_user_layout("session_123", %{preset_id: "default", placements: [...]})
      ApmV5.LayoutStore.get_user_layout("session_123")
  """
  ...
  defp load_presets do
    path = Path.join(:code.priv_dir(:apm_v5), "dashboard/presets.json")
