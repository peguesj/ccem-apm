defmodule ApmV5.UPM.PMIntegrationStore do
  @moduledoc """
  ...
  defp adapter_for(:plane), do: ApmV5.UPM.Adapters.PlaneAdapter
  defp adapter_for(:linear), do: ApmV5.UPM.Adapters.LinearAdapter
  defp adapter_for(:jira), do: ApmV5.UPM.Adapters.JiraAdapter
  defp adapter_for(:monday), do: ApmV5.UPM.Adapters.MondayAdapter
  defp adapter_for(:ms_project), do: ApmV5.UPM.Adapters.MSProjectAdapter
