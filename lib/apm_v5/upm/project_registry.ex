defmodule ApmV5.UPM.ProjectRegistry do
  @moduledoc """
  ...
  defp do_scan_and_sync do
    try do
      scanned = ApmV5.ProjectScanner.scan()
  ...
  defp broadcast_update do
    ...
    Phoenix.PubSub.broadcast(ApmV5.PubSub, @pubsub_topic, {:upm_projects_updated, projects})
  end
