defmodule ApmV5.UPM.VCSIntegrationStore do
  @moduledoc """
  ...
  defp adapter_for(:github), do: ApmV5.UPM.Adapters.GitHubAdapter
  defp adapter_for(:azure_devops), do: ApmV5.UPM.Adapters.AzureDevOpsAdapter
