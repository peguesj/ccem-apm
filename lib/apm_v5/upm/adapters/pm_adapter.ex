defmodule ApmV5.UPM.Adapters.PMAdapter do
  @moduledoc """
  ...
  @type integration :: ApmV5.UPM.PMIntegrationStore.PMIntegration.t()
  ...
  def get_adapter(:plane), do: ApmV5.UPM.Adapters.Plane
  def get_adapter(:linear), do: ApmV5.UPM.Adapters.Linear
  def get_adapter(:jira), do: ApmV5.UPM.Adapters.Jira
  def get_adapter(:monday), do: ApmV5.UPM.Adapters.Monday
  def get_adapter(:ms_project), do: ApmV5.UPM.Adapters.MSProject
