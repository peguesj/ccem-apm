defmodule ApmV5.UPM.Adapters.VCSAdapter do
  @moduledoc """
  ...
  @type integration :: ApmV5.UPM.VCSIntegrationStore.VCSIntegration.t()
  @type pr_attrs :: map()
  ...
  def get_adapter(:github), do: ApmV5.UPM.Adapters.GitHub
  def get_adapter(:azure_devops), do: ApmV5.UPM.Adapters.AzureDevOps
