defmodule ApmV5.Instrumentation do
  @moduledoc """
  ...
  ### AuthorizationGate
    * `[:apm_v5, :auth, :authorization_gate, :evaluate, :start | :stop | :exception]`

  ### AgentRegistry
    * `[:apm_v5, :agent_registry, :register]`
    * `[:apm_v5, :agent_registry, :list]`

  ### PubSub
    * `[:apm_v5, :pubsub, :broadcast]` -- measurement `:payload_bytes`

  ### ConcurrencyLayer / JobQueue / NativeTransport
    * see `ApmV5.ConcurrencyLayer`, `ApmV5.JobQueue`,
      `ApmV5.NativeTransport.UnixSocket` for their own docs.
  """
  ...
  def attach_default_handlers(threshold_ms \\ 500) do
    ...
    events = [
      [:apm_v5, :concurrency, :task, :stop],
      [:apm_v5, :concurrency, :task, :exception],
      [:apm_v5, :job_queue, :job, :stop],
      [:apm_v5, :job_queue, :job, :exception],
      [:apm_v5, :job_queue, :job, :dropped],
      [:apm_v5, :auth, :authorization_gate, :evaluate, :stop],
      [:apm_v5, :auth, :authorization_gate, :evaluate, :exception]
    ]
