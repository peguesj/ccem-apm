defmodule ApmV5.DashboardScopeEngine do
  @moduledoc """
  ...
  ## Usage
      ...
      ApmV5.DashboardScopeEngine.pin_scope_source("sess_123", "projects")
      ApmV5.DashboardScopeEngine.broadcast_scope("sess_123", :project, "ccem")
      ApmV5.DashboardScopeEngine.get_active_scope("sess_123")
      ApmV5.DashboardScopeEngine.unpin("sess_123")
  """
