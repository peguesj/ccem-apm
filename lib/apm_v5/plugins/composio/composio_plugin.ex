defmodule ApmV5.Plugins.Composio.ComposioPlugin do
  @moduledoc """
  ...
  def live_views do
    [{"/plugins/composio", ApmV5Web.ComposioLive, [as: :composio_live]}]
  end
  ...
  def plugin_live_module, do: ApmV5Web.ComposioLive
