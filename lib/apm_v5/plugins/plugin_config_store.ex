defmodule ApmV5.Plugins.PluginConfigStore do
  @moduledoc """
  ...
  Config schemas use the same string type hints as `ApmV5.WidgetRegistry`:
  ...
  defp fetch_schema(:plugin, name) do
    case ApmV5.Plugins.PluginRegistry.get_plugin_with_module(name) do
      {:ok, {mod, _meta}} ->
