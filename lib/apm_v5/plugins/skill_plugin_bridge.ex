defmodule ApmV5.Plugins.SkillPluginBridge do
  @moduledoc """
  Extension of `ApmV5.Plugins.PluginBehaviour` that adds skill-specific conventions
  ...
  @doc """
  The `use ApmV5.Plugins.SkillPluginBridge` macro wires up:
    * `@behaviour ApmV5.Plugins.PluginBehaviour`
    * `@behaviour ApmV5.Plugins.SkillPluginBridge`
