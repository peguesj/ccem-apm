defmodule ApmV5.Plugins.Pm.PmPlugin do
  @moduledoc """
  ...
  existing `ApmV5.PlaneClient`, Linear/Jira stubs return `:not_implemented`).
  """
  ...
  def handle_action("list_issues", params, _opts) do
    with_adapter(params, fn
      "plane", _mod -> ApmV5.Plugins.Plane.PlanePlugin.handle_action("list_issues", params, [])
  ...
  def handle_action("get_issue", %{"issue_id" => _} = params, _opts) do
    with_adapter(params, fn
      "plane", _mod -> ApmV5.Plugins.Plane.PlanePlugin.handle_action("get_issue", params, [])
      other, _ -> {:error, {:not_implemented, other}}
    end)
  end
  ...
  def handle_action("list_projects", params, _opts) do
    with_adapter(params, fn
      "plane", _mod -> ApmV5.Plugins.Plane.PlanePlugin.handle_action("list_projects", params, [])
      other, _ -> {:error, {:not_implemented, other}}
    end)
  end
  ...
  def handle_action("board_state", params, _opts) do
    with_adapter(params, fn
      "plane", _mod -> ApmV5.Plugins.Plane.PlanePlugin.handle_action("board_state", params, [])
      other, _ -> {:error, {:not_implemented, other}}
    end)
  end
