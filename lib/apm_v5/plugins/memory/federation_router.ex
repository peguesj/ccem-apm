defmodule ApmV5.Plugins.Memory.FederationRouter do
  @moduledoc """
  ...
  ## Usage
      ...
      iex> ApmV5.Plugins.Memory.FederationRouter.route_query(
  ...
  defp query_viki(query) do
    viki_url = Application.get_env(:apm_v5, :viki_url, "http://localhost:4010")
    viki_token = Application.get_env(:apm_v5, :viki_token, "")
