defmodule ApmV5.Plugins.Builder.BuilderEngine do
  @moduledoc """
  ...
  alias ApmV5.Plugins.Builder.BuilderSession
  alias ApmV5.Plugins.Builder.RepositoryAnalyzer
  ...
  defp broadcast(session) do
    Phoenix.PubSub.broadcast(ApmV5.PubSub, @pubsub_topic, {:builder_session_updated, session})
  end
  ...
  defp generate_plugin_code(session) do
    ...
    """
    defmodule ApmV5.Plugins.#{mod}.#{mod}Plugin do
      @moduledoc \"\"\"
  ...
  defp do_write_files(session) do
    ...
    plugin_dir = Path.join([apm_root, "lib", "apm_v5", "plugins", s])
