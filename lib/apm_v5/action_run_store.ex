defmodule ApmV5.ActionRunStore do
  @moduledoc """
      ...
      Task.start(fn ->
        ...
        result =
          if action_type in @test_action_types do
            ...
            ApmV5.ActionEngine.execute_action_public(action_type, project_path, params)
          end
  ...
  defp valid_action_type?(action_type) do
    action_type in @test_action_types or
      Enum.any?(ApmV5.ActionEngine.list_catalog(), &(&1.id == action_type))
  end
