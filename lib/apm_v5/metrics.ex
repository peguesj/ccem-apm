defmodule ApmV5.Metrics do
  ...
  `ApmV5.Metrics` is started as a child of `ApmV5Web.Telemetry` via:

      {Peep, name: :ccem_apm_metrics, metrics: ApmV5.Metrics.metrics()}
  ...
  Add to `ApmV5Web.Telemetry.init/1` children list:
