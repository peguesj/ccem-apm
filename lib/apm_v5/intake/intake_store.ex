defmodule ApmV5.Intake.Store do
  @moduledoc """
  ...
  @doc "Register a watcher module (must implement ApmV5.Intake.Watcher behaviour)."
  ...
  def init(_opts) do
    ...
    watchers = [
      ApmV5.Intake.Watchers.NotificationWatcher,
      ApmV5.Intake.Watchers.LogWatcher,
      ApmV5.Intake.Watchers.UatWatcher
    ]
  ...
  def handle_call({:submit, raw_event}, _from, state) do
    ...
    trim_table()
    ApmV5.Intake.Dispatcher.dispatch(event, state.watchers)
    Phoenix.PubSub.broadcast(ApmV5.PubSub, "intake:events", {:intake_event, event})
