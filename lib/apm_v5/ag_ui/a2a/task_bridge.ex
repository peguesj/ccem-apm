defmodule ApmV5.AgUi.A2A.TaskBridge do
  @moduledoc """
  ...
  - EventBus `"CUSTOM"` events with `name == "approval_requested"` (emitted by
    `ApmV5.AgUi.ApprovalGate`) are also handled here.
  ...
  def init(_opts) do
    ...
    Phoenix.PubSub.subscribe(ApmV5.PubSub, "apm:approvals")
    Phoenix.PubSub.subscribe(ApmV5.PubSub, "auth:pending")
