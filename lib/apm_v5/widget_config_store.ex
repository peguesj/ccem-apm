defmodule ApmV5.WidgetConfigStore do
  @moduledoc """
  ...
  ## Usage
      ...
      ApmV5.WidgetConfigStore.put_config("sess_123", "agent_fleet", %{show_sparkline: false})
      ApmV5.WidgetConfigStore.get_config("sess_123", "agent_fleet")
      ApmV5.WidgetConfigStore.get_all_configs("sess_123")
      ApmV5.WidgetConfigStore.set_pinned("sess_123", "projects")
      ApmV5.WidgetConfigStore.get_pinned("sess_123")
      ApmV5.WidgetConfigStore.clear_session("sess_123")
  """
