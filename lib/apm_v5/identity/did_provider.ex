defmodule ApmV5.Identity.DIDProvider do
  @moduledoc """
  ...
  ## Example
      ...
      iex> did = ApmV5.Identity.DIDProvider.did_for_public_key(pub)
  ...
  Derives the DID from `ApmV5.Identity.KeyStore.public_key/0` on first call,
  ...
  def cached_did do
    ...
    case :ets.lookup(@ets_cache, @cache_key) do
      ...
      [] ->
        did = ApmV5.Identity.KeyStore.public_key() |> did_for_public_key()
  ...
  def cached_did_document do
    pub_key = ApmV5.Identity.KeyStore.public_key()
