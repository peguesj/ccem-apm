defmodule ApmV5.Governance.IncidentResponseEngine do
  @moduledoc """
  ...
  ## Configuration
      ...
      config :apm_v5, ApmV5.Governance.IncidentResponseEngine,
  ...
  def init(_opts) do
    ...
    Phoenix.PubSub.subscribe(ApmV5.PubSub, @pubsub_decisions)
    Phoenix.PubSub.subscribe(ApmV5.PubSub, @pubsub_risks)
