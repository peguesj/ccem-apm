defmodule ApmWeb.Components.ShowcaseDiagrams do
  @moduledoc """
  ...
  def c4_container_diagram(assigns) do
    ...
    <div id={@id} class={["showcase-diagram relative", @class]} data-animate="true">
      ...
      >
        ...
        <desc>
          C4 Level 2 Container diagram showing the CCEM APM system boundary with its internal services and external integrations.
        </desc>
