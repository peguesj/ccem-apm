defmodule ApmWeb.V2.AgUiV2Controller do
  @moduledoc """
  ...
  alias Apm.AgUi.{EventRouter, StateManager, HookBridge}
  ...
  def tool_call(
        conn,
        %{"agent_id" => _agent_id, "tool_name" => _tool_name, "action" => _action} = params
      ) do
