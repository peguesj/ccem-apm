defmodule ApmWeb.V2.IdentityController do
  @moduledoc """
  ...
  alias Apm.Identity.{DIDProvider, KeyStore}
  ...
  `Apm.Identity.KeyStore`. The document is stable for the lifetime of the
  ...
  tokens issued by `Apm.Auth.JwtAssertion` (RFC 7523, CP-287). External
