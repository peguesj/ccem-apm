defmodule ApmWeb.AgUiController do
  @moduledoc """
  ...
  def events(conn, params) do
    ...
    agents = Apm.AgentRegistry.list_agents()
    sessions = Apm.AgentRegistry.list_sessions()
    notifications = Apm.AgentRegistry.get_notifications()
