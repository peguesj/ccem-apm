defmodule ApmWeb.AgUiPluginLive do
  @moduledoc """
  ...
  alias Apm.AgUi.AgentContextStore
  ...
  def mount(_params, _session, socket) do
    if connected?(socket) do
      Phoenix.PubSub.subscribe(Apm.PubSub, @pubsub_events)
      Phoenix.PubSub.subscribe(Apm.PubSub, @pubsub_agents)
    end
  ...
  defp load_config(socket) do
    ...
    context_store_alive = Process.whereis(Apm.AgUi.AgentContextStore) != nil
