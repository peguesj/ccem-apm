defmodule ApmWeb.HealthCheckLive do
  @moduledoc """
  ...
  def handle_event("run_checks", _params, socket) do
    Apm.HealthCheckRunner.run_now()
    Process.send_after(self(), :post_check_refresh, 300)
    {:noreply, socket}
  end

  defp assign_data(socket) do
    checks = Apm.HealthCheckRunner.get_checks()
    overall = Apm.HealthCheckRunner.get_overall_health()
