defmodule ApmWeb.UpmLive do
  ...
  def mount(_params, _session, socket) do
    if connected?(socket) do
      Phoenix.PubSub.subscribe(Apm.PubSub, "upm:projects")
      Phoenix.PubSub.subscribe(Apm.PubSub, "upm:pm_integrations")
      Phoenix.PubSub.subscribe(Apm.PubSub, "upm:vcs_integrations")
      Phoenix.PubSub.subscribe(Apm.PubSub, "upm:work_items")
      Phoenix.PubSub.subscribe(Apm.PubSub, "upm:sync")
    end
  ...
  defp skill_count do
    try do
      case Apm.ProjectStore.get_tasks("_global") do
