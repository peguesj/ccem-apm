defmodule ApmWeb.UatLive do
  ...
  alias Apm.AgUi.{EventRouter, StateManager}
  ...
  defp run_test_case("hook_bridge_register") do
    ...
    Apm.AgUi.HookBridge.translate_register(%{
      "agent_id" => agent_id,
      "project" => "uat-test",
      "role" => "individual"
    })
  ...
  defp run_test_case("hook_bridge_heartbeat") do
    ...
    Apm.AgUi.HookBridge.translate_heartbeat(%{
      "agent_id" => agent_id,
      "status" => "working",
  ...
  defp run_test_case("hook_bridge_notify") do
    ...
    Apm.AgUi.HookBridge.translate_notification(%{
      "type" => "info",
  ...
  defp run_test_case("chat_store") do
    ...
    # Send a message
    Apm.ChatStore.send_message(scope, "UAT test message", %{role: "user"})

    messages = Apm.ChatStore.list_messages(scope)
