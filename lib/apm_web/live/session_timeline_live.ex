defmodule ApmWeb.SessionTimelineLive do
  @moduledoc """
  ...
  def mount(_params, _session, socket) do
    if connected?(socket) do
      Phoenix.PubSub.subscribe(Apm.PubSub, @pubsub_topic_agents)
      Phoenix.PubSub.subscribe(Apm.PubSub, @pubsub_topic_conversations)
      Phoenix.PubSub.subscribe(Apm.PubSub, @pubsub_topic_audit)
