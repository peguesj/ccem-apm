defmodule ApmV4Web.ConversationMonitorLive do
  ...
  def mount(_params, _session, socket) do
    if connected?(socket) do
      Phoenix.PubSub.subscribe(ApmV4.PubSub, @pubsub_topic)
    end
  ...
  defp assign_data(socket) do
    conversations = ApmV4.ConversationWatcher.get_conversations()
    assign(socket,
