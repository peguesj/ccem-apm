defmodule ApmV4Web.PluginDashboardLive do
  ...
  def handle_event("rescan", _params, socket) do
    ApmV4.PluginScanner.rescan()
    Process.sleep(300)
    {:noreply, assign_data(socket)}
  end

  defp assign_data(socket) do
    mcp_servers = ApmV4.PluginScanner.get_mcp_servers()
    plugins = ApmV4.PluginScanner.get_plugins()
