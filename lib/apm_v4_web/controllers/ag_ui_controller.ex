defmodule ApmV4Web.AgUiController do
  @moduledoc """
  ...
  def events(conn, params) do
    ...
    agents = ApmV4.AgentRegistry.list_agents()
    sessions = ApmV4.AgentRegistry.list_sessions()
    notifications = ApmV4.AgentRegistry.get_notifications()
