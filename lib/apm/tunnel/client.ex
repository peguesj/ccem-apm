defmodule Apm.Tunnel.Client do
  @moduledoc """
  ...
  Flow:
    ...
    4. Forward each request to the correct local server via :httpc (Task, non-blocking)
       ...
       - Any other project → resolved via Apm.PortManager
  ...
  defp resolve_project_port(project_name) do
    configs = Apm.PortManager.get_project_configs()
  ...
  defp fallback_port_manifest do
    Apm.PortManager.get_project_configs()
