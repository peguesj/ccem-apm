defmodule Apm.Skills.SkillAnalyzer do
  @moduledoc """
  ...
  @spec get_graph() :: Apm.Skills.DependencyGraph.graph()
  def get_graph do
  ...
  def stats do
    graph = get_graph()
    Apm.Skills.DependencyGraph.stats(graph)
  end
  ...
  @spec build_and_cache([map()]) :: Apm.Skills.DependencyGraph.graph()
  defp build_and_cache(skills) do
    graph = Apm.Skills.DependencyGraph.build_graph(skills)
