defmodule Apm.Governance.ControlRegistry do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> controls = Apm.Governance.ControlRegistry.list_controls()
  ...
  ## Examples
      ...
      iex> Apm.Governance.ControlRegistry.get_control(:audit_log)
  ...
  ## Examples
      ...
      iex> Apm.Governance.ControlRegistry.controls_by_framework(:soc2, "CC6.1")
