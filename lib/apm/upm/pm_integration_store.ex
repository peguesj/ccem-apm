defmodule Apm.UPM.PMIntegrationStore do
  @moduledoc """
  ...
  defp adapter_for(:linear), do: Apm.UPM.Adapters.LinearAdapter
  defp adapter_for(:jira), do: Apm.UPM.Adapters.JiraAdapter
  defp adapter_for(:monday), do: Apm.UPM.Adapters.MondayAdapter
  defp adapter_for(:ms_project), do: Apm.UPM.Adapters.MSProjectAdapter
