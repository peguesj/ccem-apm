defmodule Apm.UPM.VCSIntegrationStore do
  @moduledoc """
  ...
  defp adapter_for(:github), do: Apm.UPM.Adapters.GitHubAdapter
  defp adapter_for(:azure_devops), do: Apm.UPM.Adapters.AzureDevOpsAdapter
