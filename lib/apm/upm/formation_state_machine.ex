defmodule Apm.Upm.FormationStateMachine do
  @moduledoc """
  Pure functional FSM for formation lifecycle states.

  Mirrors the `Apm.Auth.AgentLifecycle` pattern: typed atom states, an
  ...
  ## Usage
      ...
      iex> Apm.Upm.FormationStateMachine.transition(:registered, :staged)
      {:ok, :staged}

      iex> Apm.Upm.FormationStateMachine.transition(:completed, :running)
      {:error, :invalid_transition}

      iex> Apm.Upm.FormationStateMachine.parse("running")
      {:ok, :running}

      iex> Apm.Upm.FormationStateMachine.terminal?(:completed)
      true
  """
  ...
  ## Examples
      ...
      iex> Apm.Upm.FormationStateMachine.transition(:running, :failed)
      {:ok, :failed}
  """
  ...
  ## Examples
      ...
      iex> Apm.Upm.FormationStateMachine.terminal?(:running)
      false
  """
  ...
  ## Examples
      ...
      iex> Apm.Upm.FormationStateMachine.parse(:staged)
      {:ok, :staged}

      iex> Apm.Upm.FormationStateMachine.parse("unknown")
      {:error, :unknown_state}
  """
