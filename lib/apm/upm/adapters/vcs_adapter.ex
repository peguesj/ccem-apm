defmodule Apm.UPM.Adapters.VCSAdapter do
  @moduledoc """
  ...
  @type integration :: Apm.UPM.VCSIntegrationStore.VCSIntegration.t()
  @type pr_attrs :: map()
  ...
  def get_adapter(:github), do: Apm.UPM.Adapters.GitHub
  def get_adapter(:azure_devops), do: Apm.UPM.Adapters.AzureDevOps
