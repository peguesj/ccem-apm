defmodule Apm.Provenance.ArtifactAttestation do
  @moduledoc """
  ...
  `Apm.AuditLog.do_log/7` calls `Apm.Provenance.ArtifactAttestation.Signer.maybe_attest/5`
...
defmodule Apm.Provenance.ArtifactAttestation.Signer do
  @moduledoc """
  ...
  Called from `Apm.AuditLog.do_log/7`. No-ops for non-write tools or
