defmodule Apm.Coalesce.CoalesceOrchestrator do
  @moduledoc """
  ...
  alias Apm.Coalesce.{DecisionGateStore, SkillLogicEngine, SwarmCoordinator}
  ...
  defp _apply_diffs(run) do
    ...
    Apm.SkillsRegistryStore.refresh_all()
