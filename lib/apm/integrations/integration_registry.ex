defmodule Apm.Integrations.IntegrationRegistry do
  @moduledoc """
  GenServer + ETS registry for APM integrations.

  Integrations are registered by module (must implement
  `Apm.Integrations.IntegrationBehaviour`). The registry stores integration
  ...
  @default_integrations [
    Apm.Integrations.Agentlock.AgentlockIntegration,
    Apm.Integrations.AgUi.AgUiIntegration,
    Apm.Integrations.Lvm.LvmIntegration,
    Apm.Integrations.ClaudeMem.ClaudeMemIntegration,
    Apm.Integrations.ClaudeFlow.ClaudeFlowIntegration,
    Apm.Integrations.ClaudeExpertise.ClaudeExpertiseIntegration,
    Apm.Integrations.Uat.UatIntegration,
    Apm.Integrations.RalphIntegration,
    Apm.Integrations.Worktree.WorktreeIntegration
  ]
