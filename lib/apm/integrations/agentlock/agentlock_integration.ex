defmodule Apm.Integrations.Agentlock.AgentlockIntegration do
  @moduledoc """
  ...
  alias Apm.Auth.AuthorizationGate
  ...
  @spec status() :: atom()
  def status do
    if Process.whereis(Apm.Auth.TokenStore), do: :connected, else: :disconnected
  end
