defmodule Apm.Intake.Store do
  ...
  @doc "Register a watcher module (must implement Apm.Intake.Watcher behaviour)."
  ...
  def init(_opts) do
    ...
    watchers = [
      Apm.Intake.Watchers.NotificationWatcher,
  ...
  def handle_call({:submit, raw_event}, _from, state) do
    ...
    trim_table()
    Apm.Intake.Dispatcher.dispatch(event, state.watchers)
    Phoenix.PubSub.broadcast(Apm.PubSub, "intake:events", {:intake_event, event})
