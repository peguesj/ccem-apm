defmodule Apm.Identity.AgentRoleIndex do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> Apm.Identity.AgentRoleIndex.normalize_formation_id("formation-20260101-my-feature")
      "formation-my-feature"

      iex> Apm.Identity.AgentRoleIndex.normalize_formation_id("formation-my-feature")
      "formation-my-feature"
  """
