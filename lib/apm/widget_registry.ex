defmodule Apm.WidgetRegistry do
  @moduledoc """
  ...
  ## Usage
      ...
      Apm.WidgetRegistry.list_widgets()
      Apm.WidgetRegistry.list_by_category(:monitoring)
      Apm.WidgetRegistry.get_widget("agent_fleet")
      Apm.WidgetRegistry.register_widget(%{id: "my_widget", ...})
      Apm.WidgetRegistry.update_widget_config("agent_fleet", %{show_sparkline: false})
  """
  ...
  @builtin_widgets [
    %{
      ...
      category: :monitoring,
      source_module: Apm.AgentRegistry,
    ...
    %{
      ...
      category: :formation,
      source_module: Apm.FormationStore,
      refresh_interval: nil,
      min_width: 6,
      min_height: 4,
    ...
    %{
      ...
      category: :auth,
      source_module: Apm.Auth.PendingDecisions,
      refresh_interval: nil,
      min_width: 4,
      min_height: 3,
    ...
    %{
      ...
      category: :monitoring,
      source_module: Apm.ClaudeUsageStore,
    ...
    %{
      ...
      category: :monitoring,
      source_module: Apm.BackgroundTasksStore,
      refresh_interval: nil,
      min_width: 4,
      min_height: 3,
    ...
    %{
      ...
      category: :workflow,
      source_module: Apm.Plugins.PluginRegistry,
    ...
    %{
      ...
      category: :monitoring,
      source_module: Apm.SessionManager,
      refresh_interval: 30_000,
      min_width: 3,
      min_height: 2,
    ...
    %{
      ...
      category: :auth,
      source_module: Apm.Auth.AuthorizationGate,
      refresh_interval: nil,
      min_width: 5,
      min_height: 3,
    ...
    %{
      ...
      category: :monitoring,
      source_module: Apm.SkillsRegistryStore,
  ...
  defp load_plugin_widgets do
    ...
    case Process.whereis(Apm.Plugins.PluginRegistry) do
      nil ->
        :ok

      _pid ->
        try do
          plugins = Apm.Plugins.PluginRegistry.list_plugins()
