defmodule Apm.AgUi.V4Compat do
  @moduledoc """
  ...
  Controlled by :apm, :ag_ui_native_events config toggle.
  ...
  - :apm, :ag_ui_native_events defaults to false (legacy mode)
  ...
  @spec active?() :: boolean()
  def active? do
    not Application.get_env(:apm, :ag_ui_native_events, false)
  end
