defmodule Apm.ConfigLoader do
  ...
  def config_path do
    Application.get_env(:apm, :config_path, @default_config_path)
  end
  ...
  def handle_call({:update_project, params}, _from, state) do
    ...
    Phoenix.PubSub.broadcast(Apm.PubSub, "apm:config", {:config_reloaded, new_config})
