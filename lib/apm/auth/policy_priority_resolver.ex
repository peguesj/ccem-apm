defmodule Apm.Auth.PolicyPriorityResolver do
  @moduledoc """
  ...
  ## Usage
      ...
      Apm.Auth.PolicyPriorityResolver.resolve(rules, :deny_wins)
      #=> :always_deny
  ...
  ## Example
      ...
      iex> Apm.Auth.PolicyPriorityResolver.configured_strategy()
      :deny_wins
