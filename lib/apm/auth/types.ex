defmodule Apm.Auth.Types do
  ...
  defmodule AuthTool do
    ...
    @type t :: %__MODULE__{
            name: String.t(),
            risk_level: Apm.Auth.Types.risk_level(),
            requires_auth: boolean(),
            allowed_roles: [String.t()],
            data_boundary: Apm.Auth.Types.data_boundary(),
  ...
  defmodule AuthSession do
    ...
    @type t :: %__MODULE__{
            ...
            role: String.t(),
            data_boundary: Apm.Auth.Types.data_boundary(),
            trust_ceiling: Apm.Auth.Types.trust_level(),
  ...
  defmodule ContextEntry do
    ...
    @type t :: %__MODULE__{
            ...
            session_id: String.t(),
            agent_id: String.t(),
            source: Apm.Auth.Types.context_source(),
            trust_level: Apm.Auth.Types.trust_level(),
