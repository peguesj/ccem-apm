defmodule Apm.Auth.PolicyPredicate do
  @moduledoc """
  ...
  ## Example
      ...
      iex> pred = %Apm.Auth.PolicyPredicate{type: :env_match, params: %{env: :prod}}
      iex> Apm.Auth.PolicyPredicate.evaluate(pred, %{env: :prod})
      :match
      iex> Apm.Auth.PolicyPredicate.evaluate(pred, %{env: :dev})
      :no_match
  """
