defmodule Apm.Auth.RiskScoreAggregator do
  @moduledoc """
  ...
  Where `risk_severity/1` returns 0–4 per `Apm.Auth.Types.risk_severity/1`.
  ...
  def init(_opts) do
    ...
    Phoenix.PubSub.subscribe(Apm.PubSub, @pubsub_in)
    schedule_sweep()
  ...
  defp recompute(key, filter) do
    ...
    Phoenix.PubSub.broadcast(Apm.PubSub, @pubsub_out, {:risk_aggregated, key, aggregate})
