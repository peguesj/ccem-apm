defmodule Apm.DashboardData do
  @moduledoc """
  ...
  defp build_snapshot do
    %Snapshot{
      project_configs: safe(fn -> Apm.PortManager.get_project_configs() end, %{}),
      port_clashes: safe(fn -> Apm.PortManager.detect_clashes() end, []),
      port_ranges: safe(fn -> Apm.PortManager.get_port_ranges() end, %{}),
      saved_layouts: safe(fn -> Apm.DashboardStore.list_layouts() end, []),
      saved_presets: safe(fn -> Apm.DashboardStore.list_presets() end, []),
      upm_status: safe(fn -> Apm.UpmStore.get_status() end, nil),
