defmodule Apm.Plugins.PluginRegistry do
  @moduledoc """
  GenServer + ETS registry for APM plugins.

  Plugins are registered by module (must implement `Apm.Plugins.PluginBehaviour`).
  ...
  @default_plugins [
    Apm.Plugins.Plane.PlanePlugin,
    Apm.Plugins.Ralph.RalphPlugin,
    Apm.Plugins.Formations.FormationsPlugin,
    Apm.Plugins.Uat.UatPlugin,
    Apm.Plugins.Skills.SkillsPlugin,
    Apm.Plugins.Ports.PortsPlugin,
    Apm.Plugins.Usage.UsagePlugin,
    Apm.Plugins.Devops.DevopsPlugin,
    Apm.Plugins.Alerting.AlertingPlugin,
    Apm.Plugins.SimpleAgents.SimpleAgentsPlugin,
    Apm.Plugins.ClaudeCode.ClaudeCodePlugin,
    Apm.Plugins.Lvm.ClaudePlatformLvmPlugin,
    Apm.Plugins.Mirofish.MirofishPlugin,
    Apm.Plugins.SkillDrift.SkillDriftPlugin,
    Apm.Plugins.Orchestration.OrchestrationPlugin,
    Apm.Plugins.Memory.MemoryPlugin,
    Apm.Plugins.Worktree.WorktreePlugin,
    Apm.Plugins.Harness.HarnessPlugin,
    Apm.Plugins.OpenDesign.OpenDesignPlugin,
    Apm.Plugins.Composio.ComposioPlugin,
    Apm.Plugins.Builder.BuilderPlugin
  ]
