defmodule Apm.Plugins.OpenDesign.OpenDesignPlugin do
  @moduledoc """
  ...
  @impl true
  def live_views do
    [{"/plugins/open-design", ApmWeb.OpenDesignLive, [as: :open_design_live]}]
  end
  ...
  @impl true
  def plugin_live_module, do: ApmWeb.OpenDesignLive
