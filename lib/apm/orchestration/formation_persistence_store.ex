defmodule Apm.Orchestration.FormationPersistenceStore do
  @moduledoc """
  ...
  ETS-resident formation state in `Apm.UpmStore` from the persisted log.
  ...
  defp apply_events_to_upm(formation_id, events) do
    ...
    if is_nil(last_event) do
      ...
      Apm.UpmStore.restore_formation(formation)
    end
  end
end
