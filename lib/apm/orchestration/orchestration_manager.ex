defmodule Apm.Orchestration.OrchestrationManager do
  @moduledoc """
  ...
  defp broadcast_run_event(event, run) do
    Phoenix.PubSub.broadcast(Apm.PubSub, "orchestration:runs", {event, run})
    Phoenix.PubSub.broadcast(Apm.PubSub, "apm:orchestration", {event, run})
  end
end
