defmodule ApmV5Web.Components.AgUi.StatusBadge do
  @moduledoc "Color-coded status badge component."
  use Phoenix.Component

  @colors %{"active" => "bg-green-500/20 text-green-400", "idle" => "bg-gray-500/20 text-gray-400",
    "error" => "bg-red-500/20 text-red-400", "completed" => "bg-blue-500/20 text-blue-400",
  ...
  def status_badge(assigns) do
    assigns = assign(assigns, :cls, Map.get(@colors, assigns.status, "bg-gray-500/20 text-gray-400"))
    ~H"""
