defmodule ApmV5Web.Components.CommandBar do
  @moduledoc """
  ...
  @nav_items [
    ...
    %{section: "jump", label: "Formations",         path: "/formation",           icon: "share-2",      keywords: "swarm cluster topology"},
    %{section: "jump", label: "Timeline",           path: "/timeline",            icon: "clock",        keywords: "session events history"},
    %{section: "jump", label: "Sessions",           path: "/sessions",            icon: "layers",       keywords: "session manager"},
    %{section: "jump", label: "Conversations",      path: "/conversations",       icon: "message-square", keywords: "chat monitor"},
    %{section: "jump", label: "Analytics",          path: "/analytics",           icon: "bar-chart-2",  keywords: "metrics stats"},
    %{section: "jump", label: "Usage",              path: "/usage",               icon: "activity",     keywords: "tokens cost"},
    %{section: "jump", label: "Health",             path: "/health",              icon: "heart",        keywords: "status uptime"},
    %{section: "jump", label: "Ports",              path: "/ports",               icon: "wifi",         keywords: "network listeners"},
    %{section: "jump", label: "Tasks",              path: "/tasks",               icon: "check-square", keywords: "background jobs"},
    %{section: "jump", label: "Actions",            path: "/actions",             icon: "zap",          keywords: "commands run"},
    %{section: "jump", label: "Scanner",            path: "/scanner",             icon: "search",       keywords: "project scan"},
    %{section: "jump", label: "Skills",             path: "/skills",              icon: "package",      keywords: "skill registry"},
    %{section: "jump", label: "Skill Drift",        path: "/skill-drift",         icon: "git-branch",   keywords: "drift detect"},
    %{section: "jump", label: "Library",            path: "/library",             icon: "book-open",    keywords: "documentation"},
    %{section: "jump", label: "Memory",             path: "/memory",              icon: "database",     keywords: "observations vectorized"},
    %{section: "jump", label: "Orchestration",      path: "/orchestration",       icon: "cpu",          keywords: "dag workflow"},
    %{section: "jump", label: "Approvals History",  path: "/approvals-history",   icon: "shield",       keywords: "agentlock audit"},
    %{section: "jump", label: "Authorization",      path: "/authorization",       icon: "lock",         keywords: "agentlock auth"},
    %{section: "jump", label: "Routing",            path: "/routing",             icon: "map",          keywords: "channel route"},
    %{section: "jump", label: "Coalesce",           path: "/coalesce",            icon: "git-merge",    keywords: "skill sync"},
    %{section: "jump", label: "UPM",                path: "/upm/module",          icon: "trello",       keywords: "plane project management"},
    %{section: "jump", label: "Plugins",            path: "/plugins",             icon: "puzzle",       keywords: "extensions"},
    %{section: "jump", label: "Integrations",       path: "/integrations",        icon: "link",         keywords: "connect external"},
    %{section: "jump", label: "AG-UI",              path: "/ag-ui",               icon: "terminal",     keywords: "agent ui protocol"},
    %{section: "jump", label: "Notifications",      path: "/notifications",       icon: "bell",         keywords: "alerts events"},
    %{section: "jump", label: "Showcase",           path: "/showcase",            icon: "star",         keywords: "projects portfolio"},
    %{section: "jump", label: "Docs",               path: "/docs",                icon: "file-text",    keywords: "documentation reference"},
    %{section: "jump", label: "Architecture",       path: "/architecture",        icon: "box",          keywords: "system design"},
    %{section: "jump", label: "UAT",                path: "/uat",                 icon: "clipboard",    keywords: "user acceptance test"},
    %{section: "jump", label: "DRTW",               path: "/drtw",                icon: "compass",      keywords: "don't reinvent wheel"},
    %{section: "jump", label: "Intake",             path: "/intake",              icon: "inbox",        keywords: "issue triage"},
    %{section: "jump", label: "Alignment",          path: "/actions/alignment",   icon: "align-center", keywords: "strategy goal"},
    %{section: "jump", label: "LVM Status",         path: "/integrations/lvm",    icon: "hard-drive",   keywords: "lvm volume"},
    %{section: "jump", label: "Claude Code",        path: "/plugins/claude-code", icon: "code",         keywords: "claude plugin"},
    %{section: "jump", label: "Ralph Plugin",       path: "/plugins/ralph",       icon: "refresh-cw",   keywords: "ralph loop plugin"},
    %{section: "jump", label: "AG-UI Plugin",       path: "/plugins/ag_ui",       icon: "terminal",     keywords: "ag-ui plugin"},
    # Act — global actions
    %{section: "act",  label: "Open API Docs",      path: "/api/docs",            icon: "book",         keywords: "openapi swagger reference"},
    %{section: "act",  label: "Tool Calls",         path: "/tool-calls",          icon: "code",         keywords: "tool trace"},
    %{section: "act",  label: "A2A",                path: "/a2a",                 icon: "share",        keywords: "agent to agent"},
    %{section: "act",  label: "All Projects",       path: "/apm-all",             icon: "grid",         keywords: "multi project"},
    %{section: "act",  label: "Generative UI",      path: "/generative-ui",       icon: "layers",       keywords: "genui"},
    %{section: "act",  label: "CCEM Overview",      path: "/ccem",                icon: "info",         keywords: "overview about"},
    %{section: "act",  label: "Backfill",           path: "/backfill",            icon: "download",     keywords: "data backfill"},
    %{section: "act",  label: "Ralph Flow",         path: "/ralph",               icon: "refresh-cw",   keywords: "ralph autonomous loop"}
  ]
  ...
  defp filter_items(query) do
    ...
    @nav_items
    |> Enum.filter(fn item ->
      haystack = "#{String.downcase(item.label)} #{String.downcase(item.path)} #{String.downcase(item.keywords)}"
