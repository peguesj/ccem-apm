defmodule ApmV5Web.Components.Templates.PageShell do
  @moduledoc """
    ...
    <div class="apm-page-shell" {@rest}>
      ...
      <aside class={["apm-sidebar", @sidebar_collapsed && "apm-sidebar--collapsed"]}>
        <div class="apm-sidebar__brand">
          <ApmV5Web.Components.Core.Logo.logo size={22} />
          <%= unless @sidebar_collapsed do %>
            ...
            <ApmV5Web.Components.Core.Badge.badge tone="success" dot pulse>LIVE</ApmV5Web.Components.Core.Badge.badge>
          <% end %>
        </div>
            ...
            <div class="apm-sidebar__section">
              <%= unless @sidebar_collapsed do %>
                <div class="apm-sidebar__section-header apm-mono apm-upper">
                  <ApmV5Web.Components.Core.Icon.icon name={sec.icon} size={11} />
                  {sec.label}
                </div>
                <div class="apm-sidebar__items">
                  <%= for item <- sec.items do %>
                    ...
                    >
                      ...
                      <%= if item[:badge] do %>
                        <ApmV5Web.Components.Core.Badge.badge
              ...
              <% else %>
                <div class="apm-sidebar__section-icon">
                  <ApmV5Web.Components.Core.Icon.icon name={sec.icon} size={15} />
                </div>
              <% end %>
            </div>
          <% end %>
        ...
        <%= unless @sidebar_collapsed do %>
          <div class="apm-sidebar__footer">
            <ApmV5Web.Components.Core.Dot.dot tone="success" />
      ...
      <div class="apm-page-shell__main">
        ...
        <div class="apm-topbar">
          ...
          <button class="apm-topbar__project-switcher apm-focusable" type="button" phx-click={@on_project}>
            <ApmV5Web.Components.Core.Dot.dot decoration="iris" size={7} />
          ...
          <button class="apm-topbar__cmd-k apm-focusable" type="button" phx-click={@on_cmd_k} aria-label="Open command palette">
            ...
            <ApmV5Web.Components.Core.Kbd.kbd>⌘K</ApmV5Web.Components.Core.Kbd.kbd>
          </button>
