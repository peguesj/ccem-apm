defmodule ApmV5Web.OrchestrationController do
  @moduledoc """
  REST API controller for the orchestration system.

  Provides CRUD for orchestration runs plus replay and step advancement.
  ...
  # ── POST /orchestrations/:id/steps/:step_id/advance ─────────────────────────
