defmodule ApmV5Web.Live.Widgets.ProjectsWidget do
  @moduledoc """
  LiveComponent: Projects widget for the Dashboard Widgetization Engine.

  Displays the list of active projects from ApmV5.ConfigLoader with per-project
  ...
  alias ApmV5.{AgentRegistry, ConfigLoader}
