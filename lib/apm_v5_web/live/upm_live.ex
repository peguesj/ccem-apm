defmodule ApmV5Web.UpmLive do
  ...
  def mount(_params, _session, socket) do
    if connected?(socket) do
      Phoenix.PubSub.subscribe(ApmV5.PubSub, "upm:projects")
      Phoenix.PubSub.subscribe(ApmV5.PubSub, "upm:pm_integrations")
      Phoenix.PubSub.subscribe(ApmV5.PubSub, "upm:vcs_integrations")
      Phoenix.PubSub.subscribe(ApmV5.PubSub, "upm:work_items")
      Phoenix.PubSub.subscribe(ApmV5.PubSub, "upm:sync")
    end
  ...
  defp skill_count do
    try do
      case ApmV5.ProjectStore.get_tasks("_global") do
