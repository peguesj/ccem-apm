defmodule ApmV5Web.ProvenanceLive do
  @moduledoc """
  ...
  alias ApmV5.Provenance.{ArtifactAttestation, ProvExporter, LineageTracker}
          ...
          <div style="flex:1;overflow-y:auto;padding:1.5rem;">
            ...
            <div :if={@tab == :bundle}>
              ...
              <div style="margin-top:0.5rem;font-size:0.75rem;color:var(--ccem-text-muted);">
                W3C PROV-JSONLD bundle — generated by <code>ApmV5.Provenance.ProvExporter</code>
              </div>
            </div>
