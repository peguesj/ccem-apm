defmodule ApmV5Web.OpenDesignLive do
  @moduledoc """
  ...
  defp safe_monitor_state do
    case Process.whereis(ApmV5.Plugins.OpenDesign.OpenDesignMonitor) do
      nil ->
        %{reachable: false, agents: [], skill_count: 0, design_system_count: 0, project_count: 0, port: @daemon_port, last_checked: nil}

      _pid ->
        ApmV5.Plugins.OpenDesign.OpenDesignMonitor.current_state()
    end
  rescue
