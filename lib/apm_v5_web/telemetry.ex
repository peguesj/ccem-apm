defmodule ApmV5Web.Telemetry do
  ...
  With a Prometheus reporter (e.g. `peep` or `prom_ex`) wired in, these
  become `ccem_governance_*` gauges/counters at `/metrics`. Without one,
  they remain available for LiveDashboard and in-process consumers.
  """
