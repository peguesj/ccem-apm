defmodule ApmV5Web.ShowcaseChannel do
  @moduledoc """
  ...
  alias ApmV5.AgUi.{ActivityTracker, AgentContextStore}
  ...
  def join("showcase:" <> _project, _payload, socket) do
    ...
    Phoenix.PubSub.subscribe(ApmV5.PubSub, "apm:agent_context")
    Phoenix.PubSub.subscribe(ApmV5.PubSub, "apm:formations")
    Phoenix.PubSub.subscribe(ApmV5.PubSub, "upm:decisions")
